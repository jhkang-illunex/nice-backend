...
def test_import_price_cost_includes_elasticity_v11() -> None:
    s = Shock(
        ...
        shock_type="수입",
        target_type="HS6",
        input_type="IMPORT_PRICE",
        price_m_change_rate=0.10,
        price_m_elasticity=-0.5,
        pass_through=0.8,
    )
...
def test_import_shutdown_revenue_negative_v11() -> None:
    s = Shock(
        ...
        shock_type="수입",
        target_type="HS6",
        input_type="IMPORT_SHUTDOWN",
        import_change=0.30,
        substitute_elasticity=0.0,
    )
